...
public class StockEnricherImpl implements StockEnricher {
    ...
    public StockEnricherImpl(String baseUrl, String techBaseUrl, Map<String, String> identifierBaseHeaders, String fallBackAddition, Map<String, String> techBaseHeaders) {
